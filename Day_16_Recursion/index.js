...
4. Recursive Search Script: Create a script that includes recursive functions for in-order traversal and depth calculation of a binary tree(optional).
*/

/* Achievement:

*Understand and implement basic recursion.
*Apply recursion to solve problems with arrays and string.
