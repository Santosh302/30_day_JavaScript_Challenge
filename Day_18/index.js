...
Task 1: Implement the bulle sort algorithm to sort an array of numbers in ascending order.
...
Task 11: Write a function to solve the kanpsack problem using dynamic programming. Log the maximum value that can be obtained.
*/

/* Feature Request:
1. Sorting Alogrithm Script: Write a script that implements bubble sort, selection sort, and quicksort algorithms to sort arrays.
...
3. String Algorithm Script: Write a script that counts character occurrences and finds the longest substring without repeating charcaters.
4. Array Algorithm Script: Create a script that rotates arrays and merges sorted arrays.
5.Dynamic Programming Script: Write a script that solves the fibonacci  sequence and kanpsack problem using dynamic programming(optional).
*/

/* Achievement : 
*Implement  and understand common sorting algorithms.
*Implement and understand common searching algorithms.
*solve string manipulation problem using algorithms.
