/* Project_2 - Movie Search App */

/* Activity 1: Setting Up the Project 
Task 1: Initialize a new project directory and set up the basic HTML structure for the movie search app.
Task 2: Add a basic CSS file to style the movie search app, includeing a container for displaying movie search results.
*/
...
Task 6: Write a function to fetch and display movie data based on a search  query entered in input field. Log any errors to the console.
*/

/* Activity 4: Displaying Detailed Movie Information 
Task 7:Modify the search result to include a "More Info" button for each  movie. 
When clicked, fetch and display additional details about the movie, such as the plot, director, and actors.
Task 8: Create a model or a new section on the page to display the detailed movie information.
...
4. UI Enhancement Script: Create a script that imporoves the layout and design of the movie search app with CSS style and animations.
*/

/* Achievement:
*Set up a basic project structure with HTML and CSS.
*Use the fetch API to retrieve and display movie data from a public API.
*Implement search functionlity to fetch and display movie data based on user input.
*Fetch and display details information about selected movies.
*Enhance the user interface with CSS style and animations to make the movie search app more interactive and visually appealing.
