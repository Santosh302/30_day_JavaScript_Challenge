...
2:Stack Script: Create a script that implement a stack and uses it to reverse a string.
...
5.Graph Script:Write a script that implement a graph and performs breadth-first search (optional).
*/
...
*Understand and use graphs for network representions and pathfinding (optional).
