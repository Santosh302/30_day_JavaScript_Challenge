...
4.Loop Closure Script:Create a script that demonstrates closures in loop to ensure functions log the correct index.
5.Memorization Script: Write a script that memorizes the results of a function and demonstrates it with a factorial calculation.
*/

/* Achievement: 
*Understand and create closures in JavaScript.
*Use closure to maintain private state and create encapsulated modules.
*Apply closures in practical scenarios like generating unique IDs and memorization.
