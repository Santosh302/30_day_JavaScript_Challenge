...
*Write a function that takes an array of non-negative integer where each integer represents the height of a line drawn at each point. Find two lines that together with the x-axis from a container, such that the container holds the most water.
*Log the maximum amount of water for a few test cases.
*/

/* Activity 4: 3Sum 
Task 4: Solve the "3Sum" problem on LeetCode.
*Write a function that takes an array of integers and finds all unique triplets in array. which give the sum of zero .
*Log the triplets for a few test cases, including edge cases.
*/

/* Activity 5: Group anagrams 
Task 5: Solve the "Group Anagrams" problem on LettCode.
*Write a function that takes and array of strings and groups anagrams together.
...
5. Group Anagrams Scripts: Write a script that includes a function to group anagrams and logs the grouped anagrams.
*/
...
*Gain confidence in solving medium-level coding challenge on LeetCode.
*/