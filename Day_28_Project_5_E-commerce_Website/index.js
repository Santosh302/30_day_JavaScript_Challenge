...
Task 2: Add a basic CSS file to style the e-commerce website, including a product listing grid and shopping cart section.
*/
...
Task 6: Create  a shopping cart section that display the products added to the cart, including
the name, price, and quantity. Update the cart display whenever a product is added.
*/
...
Task 8: Add  a "Remove" Button to each item it the cart. Write a function to handle removing products from the cart and updating the display.
*/

/* Activity 5: Checkout Process 
Task 9: Create a checkout from that collects user information (e.g., name address, payment details).Style the form using CSS.
Task 10: Write a function to handle form submission, simulating the checkout process.
Display a confirmation message with the order details.
*/

/* Feature Request: 
1.Product Listing Script: Write a script to generate and display a product listing  from an array 
of product objects or a JSON file.
...
4.Checkout Process Script: Create a script to handle the checkout process, including collection user information and displaying a confirmation message.
*/
