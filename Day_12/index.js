...
Task 3: Write a script that includes a try-catch block and a finally block. Log message in the try, catch, and finally blocks to observe the exection flow.
*/
...
/* Feature Request:
1.Basic Error Handling script: Write a script that demonstrates basic error handling usinng try-catch and finally blocks.
2.Custom Error Script: Create a script that defines and throws custom errors, handling them with try-catch blocks.
3. Promise Error Handling Script:Write a script that handle error in promises using .catch() and try-catch  within async functions.
4. Fetch Error Handling Script:Create a script that handles error when using the fetch API to request data from invalid URLs.

*/

/* Achievement:
* Understand and implement basic error handling usig try-catch blocks.
