...
4.API Fetch Script: Create a script that from a public API using both promises and async/await, and logs the response data.
...
*Use async/await to handle asynchrounous code more readably.
*Fetch data from public APIs using both promises an async/await.
